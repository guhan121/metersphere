...
*/
                // 调用执行方法
                jMeterService.runSerial(request.getCaseId(), jmeterHashTree, request.getReportId(), request.getRunMode(),null);
    ...
    public String run(ApiTestCaseWithBLOBs apiCaseBolbs, String id, String debugReportId, String testPlanID, String runMode) {
        ...
        if (apiCaseBolbs != null && StringUtils.isNotEmpty(apiCaseBolbs.getRequest())) {
            try {
                ...
                // 调用执行方法
                jMeterService.runSerial(id, jmeterHashTree, debugReportId, runMode,null);
